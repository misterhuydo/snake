...
static final int TRANSACTION_showCallScreenWithDialpad = (IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_endCall = (IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_answerRingingCall = (IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_silenceRinger = (IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_isOffhook = (IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_isRinging = (IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_isIdle = (IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_isRadioOn = (IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_isSimPinEnabled = (IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_cancelMissedCallsNotification = (IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_supplyPin = (IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_handlePinMmi = (IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_toggleRadioOnOff = (IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_setRadio = (IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_updateServiceLocation = (IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_enableLocationUpdates = (IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_disableLocationUpdates = (IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_enableApnType = (IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_disableApnType = (IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_enableDataConnectivity = (IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_disableDataConnectivity = (IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_isDataConnectivityPossible = (IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_getCellLocation = (IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_getNeighboringCellInfo = (IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_getCallState = (IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_getDataActivity = (IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_getDataState = (IBinder.FIRST_CALL_TRANSACTION + 29);
}
/**
     * Dial a number. This doesn't place the call. It displays
     * the Dialer screen.
